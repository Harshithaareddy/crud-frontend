...
function EditStudent(){
    ...
    useEffect(()=>{
            Axios.get("https://crud-backend-7oq5.onrender.com/studentRoute/update-student/"+id)
            .then((res)=>{
                if(res.status === 200){
    ...
    const handleSubmit = ()=>{
        ...
        Axios.put("https://crud-backend-7oq5.onrender.com/studentRoute/update-student/"+id,data)
        .then((res)=>{
            if(res.status === 200)
